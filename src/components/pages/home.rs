...
pub fn home() -> Html {
    html! {
        ...
        <p>{ "If you want to reach me, either on professional topics, or just to chat about Devil May Cry, you can reach me on my email, via Mastodon, or via LinkedIn." }</p>
        </>
    }
}
